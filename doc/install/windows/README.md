...
La ruta del path se debería encontrar generalmente en la siguiente ruta:  ***C:\Users\......\AppData\Local\Programs\Python\Python38***
...
Descargadas las herramientas de línea de comandos de código abierto ***wkhtmltopdf*** para la conversión de HTML a PDF y formatos de imagen utilizando el motor de renderizado **Qt WebKit**, deberan de ser instaladas, la versión se encuentra citada en los requerimientos ***wkhtmltox-0.12.5-1.msvc2015-win64.exe[>](https://github.com/wkhtmltopdf/wkhtmltopdf/releases/tag/0.12.5)***  
