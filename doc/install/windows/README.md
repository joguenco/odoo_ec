...
Descargadas las herramientas de línea de comandos de código abierto ***wkhtmltopdf*** para la conversión de HTML a PDF y formatos de imagen utilizando el motor de renderizado **Qt WebKit**, deberan de ser instaladas, la versión se encuentra citada en los requerimientos  
