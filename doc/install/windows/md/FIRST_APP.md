...
```
En el directorio **/views** se crea el archivo: [***library_menu.xml***](../docs/ch03/library_app/views/library_menu.xml), el elemento **menuitem**, para escribir un registro en el modelo:**ir.ui.menu**:
