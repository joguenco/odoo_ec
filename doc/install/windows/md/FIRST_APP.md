...
En el archivo **__manifest__.py** se deberá agregar la sección categoría :  [**"category": "Services/library"**](../docs/ch03/library_app/__manifest__.py)

Una vez asignado el ID XML **(Services/library)**, al módulo categoría **(category)**, se genera automaticamente el prefijo del nombre de la categoría: **base.module_category_services_library  ("category": "Services/library")**
