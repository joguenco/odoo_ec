...
```
En el directorio **/views** se crea el archivo: [**library_menu.xml**](../docs/ch3/library_app/views/library_menu.xml), el elemento **<menuitem>**, es una instrucción para escribir un registro en el modelo:**ir.ui.menu**:
