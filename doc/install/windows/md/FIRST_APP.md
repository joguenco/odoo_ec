...
>  En el archivo **__manifest__.py** se deberá agregar en la sección **categoría** :  [**"category": "Services/library"**](../docs/ch03/library_app/__manifest__.py), con lo cual se genera automaticamente el prefijo del nombre de la categoría: **base.module_category_services_library**
