...
```
En el archivo : [**library_app/controllers/&#95;&#95;init&#95;&#95;.py**](../../../firtsApp/windows/docs/ch03/library_app/controllers/__init__.py), se deberá agregar la siguiente línea de código:
```
from . import main
```
